...
- 📊 **Informe analítico** por proyecto (presupuesto vs. imputado, desviación,
  detalle de líneas) y por centro, exportable a Excel.
...
costcontrol/
  ...
  db.py           # acceso a datos (SQLite, stdlib)
  importer.py     # importación / exportación Excel (openpyxl)
